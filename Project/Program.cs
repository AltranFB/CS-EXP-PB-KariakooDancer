...
namespace Project
{
    ...
    {
        /*
         * Learning the dance of Kariakoo is not as easy as it sounds, but if you apply some basic rules from the beginning, you can quickly become a Kariakoo master.
